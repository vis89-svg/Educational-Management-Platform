...
from .views import PaymentSelectView, RazorpayCallbackView, AdminCashApprovalView, HallTicketView
...
urlpatterns = [
    ...
    path("hall-ticket/<int:exam_id>/", HallTicketView.as_view(), name="hall-ticket"),
]
